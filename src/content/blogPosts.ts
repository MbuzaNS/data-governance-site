...
export const blogPosts: BlogPost[] = [
  {
    ...
    image: '/blog-loved-in-principle-ignored-in-practice.png',
    cardImage: '/blog-loved-in-principle-ignored-in-practice-card.png',
    content: [
      'Most organisations do not fail at data governance because they do not understand it.',
      'They fail because leadership does not stay with it.',
      'Everyone says data governance is important.',
      'Until it asks for executive attention.',
      'A real budget.',
      'And a minimum of three years’ patience.',
