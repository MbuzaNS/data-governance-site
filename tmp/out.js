...
var defineBlogPost = (post) => post;

// src/content/blog/posts/africaAiBias.ts
var africaAiBiasPost = defineBlogPost({
  ...
  excerpt: "Artificial intelligence systems have been trained on a world that barely noticed Africa. That is not a reason for despair \u2014 it is a strategic opportunity to write the next chapter of intelligence itself.",
  date: "Jun 2026",
  category: "Artificial Intelligence",
  image: "/blog-2.jpg",
  cardImage: "/blog-2.jpg",
  eyebrow: "African AI & Data Sovereignty Series \xB7 June 2026",
      ...
      items: [
        {
          letter: "P",
          title: "Political",
          description: "African governments must legislate data sovereignty frameworks, mandate local data storage, and fund national AI strategies. The African Union's (AU's) AI Continental Strategy (2024) is a start \u2014 but requires teeth."
        },
        {
          letter: "E",
          title: "Economic",
          description: "Africa's AI deficit is an economic opportunity in disguise. Every gap in training data is a market. Founders who build African-language NLP tools or African health datasets are building sovereign IP with continental-scale value."
        },
        {
          letter: "S",
          title: "Social",
          description: 'Ubuntu philosophy \u2014 "I am because we are" \u2014 is not merely cultural heritage. It is a design principle for ethical AI, offering alternative frameworks for how AI can relate to human communities.'
        },
        {
          letter: "T",
          title: "Technological",
          description: "Africa already leads in mobile-first innovation \u2014 M-Pesa, Flutterwave, Andela. Researchers at Masakhane, Lelapa AI, and Deep Learning Indaba are building the technical foundations now."
        },
        {
          letter: "E",
          title: "Environmental",
          description: "Africa bears a disproportionate share of global climate impacts relative to its emissions contribution. African AI applied to agriculture and early warning systems could generate solutions the West is not positioned to build."
        },
        {
          letter: "L",
          title: "Legal",
          description: "Only 36 African countries have data protection legislation. Harmonising data governance across the African Continental Free Trade Area (AfCFTA) framework would create the foundation for a unified African data economy."
        }
      ]
    },
    {
